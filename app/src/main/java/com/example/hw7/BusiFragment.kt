 ...
 * Use the [BusiFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class BusiFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        var requestGet = Request.Builder().url("https://api.nytimes.com/svc/topstories/v2/business.json?api-key=ApC7evRJfy3oG9pZOqobZcKtlG8FFLNE").build()
    ...
    companion object {
         ...
         * @return A new instance of fragment BusiFragment.
         */
